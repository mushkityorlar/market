...
public class OutputProductDto extends GenericDto {
    ...
    public OutputProductDto(Long id, double amount, Double price, Double discountedPrice, Long currencyId, Long measurementId, Long inputProductId, LocalDateTime expiry_date) {
        super(id);
        this.amount = amount;
        this.price = price;
