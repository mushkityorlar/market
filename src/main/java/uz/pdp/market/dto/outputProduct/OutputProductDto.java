...
public class OutputProductDto extends GenericDto {
    ...
    public OutputProductDto(Long id, Double amount, Double price, Double discountedPrice, String soldById, String currencyId, String inputProductId, LocalDateTime expiry_date) {
        super(id);
        this.amount = amount;
        this.price = price;
