...
public class OutputProductUpdateDto extends GenericDto {
    ...
    @Builder
    public OutputProductUpdateDto(Long id, Double amount, Double price, String soldById, Double discountedPrice, String currencyId, String inputProductId, LocalDateTime expiry_date) {
        super(id);
        this.amount = amount;
        this.price = price;
