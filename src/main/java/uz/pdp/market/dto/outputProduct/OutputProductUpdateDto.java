...
public class OutputProductUpdateDto extends GenericDto {
    ...
    @Builder
    public OutputProductUpdateDto(Long id, Double amount, Double price, Double discountedPrice, Long soldBy, Long currencyId, Long inputProductId, LocalDateTime expiry_date) {
        super(id);
        this.amount = amount;
        this.price = price;
