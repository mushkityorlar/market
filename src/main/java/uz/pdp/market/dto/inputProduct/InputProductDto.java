...
public class InputProductDto extends GenericDto {
    ...
    public InputProductDto(Long id, String productId, Integer amount, String measurementId, Double incomePrice, Double outcomePrice, Date expireDate, String currencyId) {
        super(id);
